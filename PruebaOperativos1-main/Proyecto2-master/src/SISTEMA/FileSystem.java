...
public class FileSystem {
        ...
        if (dir != null) {
            ...
            while (actual != null) {
                if (actual.dato.name.equals(request.getFileName())) {
                    // 🔧 CORRECCIÓN: Limpiar buffer antes de liberar bloques
    ...
    public void cargarDesdeArchivo() {
        ...
        try (FileReader reader = new FileReader(FILE_NAME)) {
            ...
            // 🔧 CORRECCIÓN: Cargar estado del disco después de cargar filesystem
    ...
    // 🆕 NUEVO MÉTODO: Reconstruir el mapa de bloques a archivos
    ...
    // 🔧 MÉTODO CORREGIDO: Ahora limpia correctamente todos los datos
    public void borrarTodo() {
        // Limpiar buffer de todos los archivos
        limpiarDirectorioDelBuffer(root);
        
        // Liberar todos los bloques recursivamente
    ...
    // 🆕 NUEVO MÉTODO: Liberar bloques recursivamente
